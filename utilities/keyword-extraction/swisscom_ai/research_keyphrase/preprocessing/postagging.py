...
class PosTaggingCoreNLP(PosTagging):
    ...
    def __init__(self, host='services.loadbalancer.api.questo.ai' ,port=9000, separator='|'):
        # self.parser = CoreNLPParser(url=f'http://{host}:{port}')
        self.parser = CoreNLPParser(url='http://services.loadbalancer.api.questo.ai:9000')
        self.separator = separator
